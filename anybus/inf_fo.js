...
function PeriodicTimerUpdateStatusData()
{
  ...
  if (CardSlot >= 0){
    var DataParams     = "data=fiber-info:"+CardSlot;
...
function DynamicCreateTable(ImageIdx)
{
  ...
  var RightIds = new Array("Network"+ImageIdx,"Baudrate"+ImageIdx,"StationCount"+ImageIdx,"Redundancy"+ImageIdx,"Setting"+ImageIdx);
  var LeftIds = new Array("네트워크:","전송속도:","채널에서 스테이션 카운트 활성화:","이중화:","설정:");
