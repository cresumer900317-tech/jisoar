...
function WriteChannelInfoForChannel(InfoArray)
{
  ...
  //var Termination  = parseInt(InfoArray[6]);   // termination is set by rotary
  ...
  SetInnerHtmlValue("Terminator"+ChannelNum,"로터리 스위치에 의해 설정");
...
function PeriodicTimerUpdateStatusData()
{
  ...
  if (CardSlot >= 0){
    ...
    var DataParams     = "data=salt-info:"+CardSlot;
